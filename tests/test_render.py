...
# [render_tver] Verify rendering succeeds for valid series
...
# [render_tver] Verify rendering fails for invalid series
...
# [render_tver] Verify rendering fails for not airing series
